...
class HAN(nn.Module):
    def __init__(self,in_channels, n_resgroups, n_resblocks, n_feats, reduction, rgb_range, res_scale, conv=common.default_conv):
        ...
        # define head module
        modules_head = [conv(in_channels, 128, kernel_size)]
